...
> 如果你从 Git 仓库下载的是 `cpe_test-v4.5.0-windows-config-docs.zip`，那是一份只含
> 配置、文档和启动脚本的资料包，不含 `cpe_test.exe`、`ctsTraffic.exe` 或 iperf3。
> 开箱即用请下载 GitHub Release 的 `cpe_test-v4.5.0-windows-x86_64.zip`；也可以自行
...
- `ctsTraffic.exe`：Microsoft ctsTraffic 2.0.4.0 x64，随官方 v4.5.0 Windows 包固定捆绑并校验；仅支持 Windows 10 或更高版本。
